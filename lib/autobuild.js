...
async function run() {
    ...
    try {
        ...
        if (language === 'java') {
            // Update JAVA_TOOL_OPTIONS to contain disable keep-alives and increase timeouts.
            // This is because of an issue with Azure pipelines timing out connections after 4 minutes
            // and Maven not properly handling closed connections
            // Otherwise long build processes will timeout when pulling down Java packages
            // https://developercommunity.visualstudio.com/content/problem/292284/maven-hosted-agent-connection-timeout.html
            let javaToolOptions = process.env['JAVA_TOOL_OPTIONS'] || "";
            process.env['JAVA_TOOL_OPTIONS'] = javaToolOptions + ' -Dhttp.keepAlive=false -Dmaven.wagon.http.pool=false -Dhttp.socketTimeout=60000 -Dhttp.connectionTimeout=60000';
        }
