...
async function run() {
    try {
        ...
        // Setup CODEQL_RAM and LGTM_TYPESCRIPT_RAM flags
        // (todo improve this https://github.com/github/dsp-code-scanning/issues/935)
        const codeqlRam = process.env['CODEQL_RAM'] || '6500';
        core.exportVariable('CODEQL_RAM', codeqlRam);

        const typescriptRam = process.env['LGTM_TYPESCRIPT_RAM'] || '6500';
        core.exportVariable('LGTM_TYPESCRIPT_RAM', typescriptRam);
